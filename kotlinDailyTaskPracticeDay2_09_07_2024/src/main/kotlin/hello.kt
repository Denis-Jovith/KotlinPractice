                ...
                call.respondHtml {
                    ...
                    body {
                        ...
                        div("content") {
                            ...
                            p { +"This portfolio website is designed to showcase my skills, achievements, and background. Built with Kotlin and Ktor, it demonstrates my ability to create dynamic, server-side applications." }

                            h2 { +"Skills" }
                            ul {
                                li { +"Kotlin Programming" }
                                li { +"Web Development with Ktor" }
                                li { +"Database Management" }
                                li { +"Problem Solving and Algorithms" }
            ...
            get("/about") {
                call.respondHtml {
                    ...
                    body {
                        ...
                        div("content") {
                            h2 { +"Who I Am" }
                            p { +"My name is Denis Jovith, a passionate developer with a keen interest in web development, mobile app development, and database management. I am currently pursuing my degree at Mbeya University of Science and Technology." }

                            h2 { +"Educational Background" }
                            ul {
                                li { +"Bachelor of Science in Computer Science, Mbeya University of Science and Technology (Expected Graduation: 2025)" }
